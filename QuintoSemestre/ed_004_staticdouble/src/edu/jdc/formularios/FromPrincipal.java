...
public class FromPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panelOpciones.setBackground(new java.awt.Color(153, 0, 0));
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        String datoValor = JOptionPane.showInputDialog(null, "Ingrese el numero", "Tamaño", JOptionPane.INFORMATION_MESSAGE);
        try {
            if (miArreglito == null) {
